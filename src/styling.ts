...
export function stylePages() {
    ...
    if (login) {
        ...
        if (sidebar) {
            ...
            themeSwitcher.addEventListener('click', switchTheme as EventListener, false);
        ...
        switch (page) {
            case 'stu.teach_plan':
                ...
                switch (pageMode) {
                    case 'advanced':
                        {
                            let el = span9.querySelector('a:nth-child(2)') as HTMLElement;
                            el.className = 'icon-button icon-feedback';
                            el.innerText = 'Оставить отзыв';
                    ...
                    case null:
                        {
                            let el = span9.querySelector('div:nth-child(2)');
                            el.className = 'teach-plan';

                            el = span9.querySelector('div:nth-child(2) > div > a');
                            el.className = 'icon-button icon-feedback';
                            el.innerHTML = 'Оставить отзыв';
            ...
            case 'stu.teachers':
                {
                    ...
                    const descriptions = span9.querySelectorAll('.teacher_desc .teacher_name, .teacher_desc .chair');
            ...
            case 'stu.timetable':
                ...
                let el = span9.querySelector('div:nth-child(6)') as HTMLElement;
            ...
            case 'stu_email_pkg.change_email':
                ...
                const emailInput = changeEmailForm.querySelector("#email") as HTMLInputElement;
            ...
            case 'stu.announce':
                ...
                messages.forEach(msg => {
                    ...
                    const time = msg.querySelector('font[color="#808080"]') as HTMLElement;
                ...
                notes.forEach(msg => {
                    ...
                    if (!msg.className.match(/repl_s/)) {
                        ...
                        answerButton.addEventListener('click', () => {
                            ...
                            const listElementWithPadding = msg.querySelector('li:nth-last-child(3)') as HTMLElement;
                            const listElemenNeedsPadding = msg.querySelector('li:nth-last-child(2)') as HTMLElement;
                            if (listElementsCount > 2) {
                                listElementWithPadding.style.paddingBottom = '0 !important';
                                listElemenNeedsPadding.style.paddingBottom = '3.2rem';
                            }
                            else {
                                listElementWithPadding.style.paddingBottom = '1.8rem !important';
                            }
                        });
            ...
            case 'cert_pkg.stu_certif':
                ...
                fonts.forEach(font => {
                    const img = span9.querySelector('img[src="/etis/pic/text-2.png"]') as HTMLElement;
                    if (img) {
                        const btn = document.createElement('a');
                        btn.className = 'icon-button2';
                        btn.text = 'description';
